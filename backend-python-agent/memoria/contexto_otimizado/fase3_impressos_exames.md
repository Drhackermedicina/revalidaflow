...
## o campo idestacao deve ter REVALIDA_FACIL"idEstacao": "REVALIDA_FACIL_ "idEstacao": "REVALIDA_FACIL_"idEstacao": "REVALIDA_FACIL_ 
...
- * **Sintomas do motivo de consulta e descriçãocompletadocaso:** Crie um `contextoOuPerguntaChave` para cada sintoma principal (Ex: "DOR ABDOMINAL", "SANGRAMENTO VAGINAL"). Isso organiza a informação e facilita a criação de itens de avaliação específicos no PEP.
...
*** "QUANDO UM SINTOMA GUIA TIVER SINTOMAS ASSOCIOADOS OU SINTOMAS ACOMPANHANTES VOCE NAO EXIBA NO MESMO CONTEXTOPALAVRACHAVE, E SIM COLOQUE NO CONTEXTOPALAVRA CHAVE "SINTOMAS ACOMPANHANTES" JUNTAMENTE COM OS OUTROS ***
