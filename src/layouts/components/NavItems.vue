...
<template>
  ...
  <VerticalNavGroup :item="{ title: 'Área do Candidato', icon: 'ri-user-3-fill', iconColor: '#1976d2', }" >
    <VerticalNavLink :item="{ title: 'Progresso', icon: 'ri-bar-chart-fill', iconColor: '#00bcd4', to: '/candidato/progresso', }" />
    <VerticalNavLink :item="{ title: 'Estatísticas', icon: 'ri-pie-chart-2-fill', iconColor: '#ff9800', to: '/candidato/estatisticas', }" />
    <VerticalNavLink :item="{ title: 'Histórico', icon: 'ri-history-fill', iconColor: '#607d8b', to: '/candidato/historico', }" />
    <VerticalNavLink :item="{ title: 'Performance', icon: 'ri-bar-chart-grouped-fill', iconColor: '#43a047', to: '/candidato/performance', }" />
  </VerticalNavGroup>

  <VerticalNavGroup :item="{ title: 'Assinatura', icon: 'ri-vip-crown-2-fill', iconColor: '#fbc02d', }" >
    <VerticalNavLink :item="{ title: 'Renovação', icon: 'ri-refresh-fill', iconColor: '#00bcd4', to: '/pagamento', }" />
  </VerticalNavGroup>

  <!-- Seção Administração - Visível apenas para admins -->
  <VerticalNavGroup v-if="showAdminMenu" :item="{ title: 'Administração', icon: 'ri-shield-keyhole-fill', iconColor: '#d32f2f', }" >
