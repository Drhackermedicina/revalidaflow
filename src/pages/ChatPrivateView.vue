...
onMounted(() => {
  ...
  // Carregar e ouvir apenas as últimas mensagens (tail) para reduzir leituras
  const mq = query(messagesCollectionRef, orderBy('timestamp', 'asc'), /* servidor ordena asc */ limit(100));
