        ...
        <VCard class="resultado-card" elevation="8">
          <VCardText class="text-center pa-8">
            <VIcon
              ...
              class="mb-6"
            />
            <h2 class="text-h3 font-weight-bold mb-4 text-dark">Pagamento Aprovado!</h2>
            <p class="text-body-1 mb-6 text-grey-darken-1">
              Seu pagamento foi processado com sucesso. Você receberá um email de confirmação em instantes.
            </p>
...
onMounted(() => {
  ...
  if (import.meta.env.DEV) {
    console.log('Pagamento aprovado:', referenceId.value)
  }
})
