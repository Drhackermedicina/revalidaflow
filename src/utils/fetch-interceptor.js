      ...
      if (error.message && 
        ...
        if (url.includes('revalida-backend') && !isRetrying) {
          ...
          try {
            ...
            if (retryResult.ok) {
              console.log('✅ Retry bem-sucedido após CSP violation')
              return retryResult
            }
          } catch (retryError) {
...
export function installFetchInterceptor() {
  if (typeof window !== 'undefined' && window.fetch === originalFetch) {
    ...
    console.log('🔧 Interceptor de fetch instalado para problemas de CSP')
  }
}
...
export function uninstallFetchInterceptor() {
  if (typeof window !== 'undefined') {
    ...
    console.log('🔧 Interceptor de fetch removido')
  }
}
